...
class SignUpViewController: UIViewController {
    ...
    private lazy var nameInputField: APLabeledTextField = {
        return APLabeledTextField(title: "Nome", placeholder: "Digite seu nome completo")
    }()
    
    private lazy var emailInputField: APLabeledTextField = {
        let inputField = APLabeledTextField(title: "Email", placeholder: "Digite seu e-mail completo")
    ...
    private lazy var phoneNumberInputField: APLabeledTextField = {
        let inputField = APLabeledTextField(title: "Telefone", placeholder: "Telefone com DDD")
